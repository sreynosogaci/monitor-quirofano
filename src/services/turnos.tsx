...
export const getSalas = async (): Promise<{ id: string, label: string }[]> => {
    return salas
}

export const getSala = async (salaId: string) => {
...
export const getTurnos = async (salaId?: string): Promise<Turno[]> => {
    if (salaId) {
        return turnos.filter((turno) => turno.sala === salaId) as Turno[]
    }
